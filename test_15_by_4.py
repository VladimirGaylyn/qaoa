"""
Test Suite: 15 assets, select 4
Run 20 experiments and store results in '20_by_15' folder
"""
...
def main():
    ...
    print("="*60)
    print("STARTING TEST SUITE: 15 ASSETS, SELECT 4")
    print("Testing ultra_optimized_v3 with 15x4 configuration")
    print("="*60)
    ...
    # Plot 6: Circuit Depth vs Performance
    axes[1, 2].scatter(circuit_depths, approximation_ratios, alpha=0.6, s=100)
    axes[1, 2].set_xlabel('Circuit Depth')
    axes[1, 2].set_ylabel('Approximation Ratio')
    axes[1, 2].set_title('Circuit Depth vs Performance')
    axes[1, 2].grid(True, alpha=0.3)
    
    plt.suptitle('15 Assets, Select 4 - Test Suite Summary', fontsize=16, y=1.02)
    plt.tight_layout()
    ...
    print("\n" + "="*60)
    print("FINAL STATISTICS (20 RUNS) - 15 ASSETS, SELECT 4")
    print("="*60)
